...
/*
 * Purpose: Looking at pictures and how they work.
 * 
 * Shawn Velsor
 * 4/7/2021
*/
...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener {
  ...
  public static void main(String args[]) {
    Picture pix = new Picture("APCS\\Mod08\\pixLab\\images\\arch.jpg");
    pix.keepOnlyRed();
    pix.explore();
    /*
     * Picture p = new Picture("APCS\\Mod08\\pixLab\\images\\arch.jpg"); Picture
     * smallP = p.scale(0.25, 0.25); smallP.write("smallArch.jpg");
     * smallP.explore();
     */
  }
