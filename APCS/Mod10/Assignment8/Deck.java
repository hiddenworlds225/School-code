...
public class Deck {
   ...
   public Deck(String[] ranks, String[] suits, int[] values) {
      ...
      // initialize cards as a new ArrayList -- done
      // loop through the parameter arrays to add new cards -- done
      // assign size of cards to the size instance variable -- done
      // shuffle cards
   ...
   public Card deal() {
      ...
      Card returningCard = cards.get(size - 1);
      size -= 1;
